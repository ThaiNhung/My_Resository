...
Promise.all([
  faceapi.nets.faceRecognitionNet.loadFromUri('https://raw.githubusercontent.com/lamtuanvutv/face-recognition/master/models'),
  ...
  return Promise.all(
    labels.map(async label => {
      ...
      for (let i = 1; i <= 2; i++) {
        ...
        const img = await faceapi.fetchImage(`https://raw.githubusercontent.com/lamtuanvutv/face-recognition/master/labeled_images/${label}/${i}.jpg`)
